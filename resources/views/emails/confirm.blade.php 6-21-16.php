...
<html lang="en">
  ...
  <header id="header">
    ...
    <div class="header-title">
    	<h1>Thank you for choosing IntactFX as your Forex Broker! </h1>
    </div>
  ...
  <section id="main">
    ...
    <div class="container">
        ...
        <div class="gap"></div>
        <h3 class="text-center">We wish you success in trading using IntactFX | Making A Difference</h3>
