...
class CheckCommissionTable extends Job implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        foreach ($closeTrades as $trade) {
            ...
            $amount = $volume * 10; // 1 lot volume, equal to $10 usd
            ...
            if ($profit==0) {
                ...
                if ($account_type=='mini' OR $account_type=='standard') {
                    ...
                    $first_level_commision  = $amount * .6;
                    $second_level_commision = $amount * .2;
                    $third_level_commision = $amount * .2;

                }else{

                    $first_level_commision  = $amount * .1;
                    $second_level_commision = $amount * .05;
                    $third_level_commision = $amount * .03;
                    $forth_level_commision = $amount * .015;
                    $fifth_level_commision = $amount * .005;
