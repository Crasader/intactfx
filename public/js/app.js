...
},{"./core/bootstrap":20,"./intactfx":23}],20:[function(require,module,exports){
'use strict';
...
},{"bootstrap":1,"jquery":14,"moment":15,"vue":18,"vue-resource":17}],21:[function(require,module,exports){
// Vue Components
...
module.exports = {
	...
	methods: {
		...
		submitMini: function submitMini() {
			//create account
			// alert('click')
			// return false
			this.$http.post('/mt4/create', this.intactdata).then(function (data, status, request) {
		...
		submitTransferIn: function submitTransferIn() {
			//transfer in
			this.$http.post('/mt4/transferin', this.intactdata.setSelected).then(function (data, status, request) {
		...
		submitChangePass: function submitChangePass() {
			...
			this.$http.get('account/checkpassword?password=' + this.intactdata.profile.password + '&mt4login_id=' + this.intactdata.setSelected.mt4Account_id + '&passwordType=' + this.intactdata.setSelected.passwordType).then(function (result) {
				...
				if (result.data.length != 0) {
					...
					this.$http.post('mt4/changepassword', this.intactdata).then(function (data, status, request) {}, function (data, status, request) {});
		...
		openModal: function openModal(accountType, passwordType) {
	...
	computed: {
		...
		countPass: function countPass() {
			return this.intactdata.profile.password.length;
		},

		countPassInvestor: function countPassInvestor() {
			return this.intactdata.profile.new_password.length;
		},

		monitorWithdrawal: function monitorWithdrawal() {
...
},{"./core/components":21,"./core/directives":22}]},{},[19]);
